...
else {console.log("Withdrawal denied for " + account3.name + ": insufficient funds")
};
...
for {
if (acc.type === "Savings") {
let interest = account.bal * 0.02;
acc.bal+= interest;
console.log(account.name + " received interest. New bal: " + account.bal);

else if (account.type === "Checking") {
acc.bal -= 50
console.log(acc.name + " charged fee. New bal: " + account.bal);
